...
govApp.controller('GovernanceController', function GovernanceController($scope) {
    $scope.templates = [
            ...
            },
            {
                ...
                size: 'LRS',
                specs: '500TB',
                internal price: '€25/month per TB',
